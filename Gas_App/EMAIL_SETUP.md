# Gas Tracker Email Collection Setup

Use this guide to connect the Gas Tracker landing page (`docs/index.html`) to Supabase so you can collect beta tester and release notification emails.
